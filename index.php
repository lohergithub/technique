...
<html>
    <head>
        <title> Add Remove Select Box Fields Dynamically using
        jQuery Ajax in PHP </title>
    ...
    <body>
        <br/>
        <div class="container">
            <h3 align="center"> Add Remove select Box Fields
            Dynamically using jQuey Ajax in PHP</h3>
            <br/>
...
$(document).ready(function() {
    ...
    $('#insert_form').on('submit', function(event) {
        ...
        $('.item_name').each(function(){
            ...
            if($(this).val() == '')
            {
                error += "<p> Entrer Item Name at "+count+" Row </p>";
                return false;
            }
            count = count + 1;
        });
        $('.item_quantity').each(function(){
            ...
            if($(this).val() == '')
            {
                error += "<p> Entrer Item Quantity at "+count+" Row </p>";
                return false;
            }
            count = count + 1;
        });
